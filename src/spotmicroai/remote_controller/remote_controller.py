            ...
            while True:
                ...
                try:
                    ...
                    if evbuf:
                        ...
                        # print(f"buftime: {buftime}, value: {value}, type: {type}, number: {number}")
    ...
    def check_for_connected_devices(self):
        ...
        for fn in os.listdir('/dev/input'):
            ...
            if fn.startswith(str(connected_device)):
                ...
                while True:
                    # Check if you have permissions to /dev/input/js0 yet. 
                    # This can be an issue when running as a systemd service. The pi user may still not have access and need to wait
                    try:
